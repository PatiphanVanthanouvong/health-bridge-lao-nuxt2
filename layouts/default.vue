    ...
    >
      ...
      <v-list dense shaped>
        ...
        >
          ...
          <!-- Main v-list-group with white icons -->
          <v-list-group
            :key="'report-dropdown'"
            color="white"
            class="white--text"
          ...
          >
            <template v-slot:activator>
              <v-list-item-title class="white--text">
                <v-icon color="white" class="mr-8">mdi-comment-multiple</v-icon>
                ລາຍງານທັງໝົດ
              </v-list-item-title>
            </template>
            <v-list-item
              v-for="(report, reportIndex) in inspireReports"
            ...
            >
              <v-list-item-action>
                <v-icon class="white--text">{{ report.icon }}</v-icon>
              </v-list-item-action>
              <v-list-item-content>
                <v-list-item-title class="white--text">
                  {{ report.title }}
      ...
      inspireReports: [
        {
          ...
          title: 'ລາຍງານສະຖານທີ່ທາງການເເພດ',
          to: '/reports/report_facilities',
        },
        {
          icon: 'mdi-file-document-outline',
          title: 'ລາຍງານປະເພດສະຖານທີ່ທາງການເເພດ',
          to: '/reports/report_fac_type',
        },
        {
          icon: 'mdi-file-document-outline',
          title: 'ລາຍງານການບໍລິການທາງການເເພດ',
          to: '/reports/report_service',
        },
        {
          icon: 'mdi-file-document-outline',
          title: 'ລາຍງານຜູ້ໃຊ້ງານ',
          to: '/reports/report_user',
        },
        {
          icon: 'mdi-file-document-outline',
          title: 'ລາຍງານຜູ້ດູເເລລະບົບ',
          to: '/reports/report_admin',
        },
        {
          icon: 'mdi-file-document-outline',
          title: 'ລາຍງານການສະເເດງຄວາມຄິດເຫັນ',
          to: '/reviews',
        },
      ],
    }
